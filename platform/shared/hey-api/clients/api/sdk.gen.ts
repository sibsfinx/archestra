 ...
 */
export const updateMemberMemoryAccess = <ThrowOnError extends boolean = false>(options: Options<UpdateMemberMemoryAccessData, ThrowOnError>) => (options.client ?? client).patch<UpdateMemberMemoryAccessResponses, UpdateMemberMemoryAccessErrors, ThrowOnError>({
    url: '/api/members/{memberId}/memory-access',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * List memories for the settings UI, scoped by visibility
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const getMemories = <ThrowOnError extends boolean = false>(options: Options<GetMemoriesData, ThrowOnError>) => (options.client ?? client).get<GetMemoriesResponses, GetMemoriesErrors, ThrowOnError>({ url: '/api/memory', ...options });
...
/**
 * Enable or disable durable memory for the organization
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
